...
const proxyAgent = proxyUrl ? new HttpsProxyAgent(proxyUrl.startsWith('http') ? proxyUrl : 'http://' + proxyUrl) : null;

console.log('GEMINI_API_KEY loaded:', !!process.env.GEMINI_API_KEY, 'length:', (process.env.GEMINI_API_KEY || '').length);
if (proxyAgent) console.log('Using proxy:', proxyUrl);
